...
(Step 4) Conclusion: At a 90% significance level, there is not enough evidence (p-value=0.1215) to reject that the true population mean of lead concentration of inshore water around Mombasa is greater than 30 mg/kg (dry weight).
